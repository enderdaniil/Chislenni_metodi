...
def trapeze_integral_solvation(fragmentation_count):
    ...
    for i in range(fragmentation_count):
        integral_value += (step / 2) * (func(current_x) + func(current_x + step))
        current_x += step
...
for i in range(1, 7):
    ...
    integral = trapeze_integral_solvation(fragmentation)
